...
import com.xiaowei.mapper.mapper.SelfAclDOMapper;
...
*/
@Repository
public class SelfAclDAO{

    @Autowired
    private SelfAclDOMapper selfAclDOMapper;
     ...
     * @return int
     */
    public int insert(SelfAclDO entity){
        return selfAclDOMapper.insert(entity);
    }
    /**
     ...
     * @return int
     */
    public int update(SelfAclDO entity){
        return selfAclDOMapper.update(entity);
    }
    /**
    ...
    public int deleteById(Long id){
        return selfAclDOMapper.deleteById(id);
    }
    /**
     ...
     * @return SelfAclDO
     */
    public SelfAclDO getById(Long id){
        return selfAclDOMapper.getById(id);
    }
}
